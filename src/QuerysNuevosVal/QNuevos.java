...
public class QNuevos {
    ...
    public ArrayList<String[]> Individual_FaseSolTSA() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  TRAMITACION_DEPURACION, AUDIENCIA_PRELIM, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, DECODE(FASE_SOLI_EXPEDIENTE,\n"
    ...
    public ArrayList<String[]> Individual_FechaACP() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  TRAMITACION_DEPURACION, AUDIENCIA_PRELIM, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, FECHA_ACTO_PROCESAL, FECHA_DEPURACION, COMENTARIOS\n"
                + "FROM V3_TR_INDIVIDUALJL\n"
                + "WHERE TRAMITACION_DEPURACION = 1\n"
                + "  AND AUDIENCIA_PRELIM = 2\n"
                + "  AND AUDIENCIA_JUICIO = 2\n"
    ...
    public ArrayList<String[]> Individual_FechaDRAD() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  TRAMITACION_DEPURACION, AUDIENCIA_PRELIM, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, FECHA_DICTO_RESOLUCION_AD, FECHA_DEPURACION, COMENTARIOS\n"
                + "FROM V3_TR_INDIVIDUALJL\n"
                + "WHERE TRAMITACION_DEPURACION = 1 \n"
                + "    AND AUDIENCIA_PRELIM = 2\n"
                + "    AND AUDIENCIA_JUICIO = 2 \n"
    ...
    public ArrayList<String[]> Individual_FechaUAP() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  TRAMITACION_DEPURACION, AUDIENCIA_PRELIM, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, \n"
    ...
    public ArrayList<String[]> Colectivo_FaseSolTPAD() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE,  AUTO_DEPURACION, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, DECODE(FASE_SOLI_EXPEDIENTE,\n"
                + "       1, 'Audiencia preliminar',\n"
                + "       2, 'Audiencia de juicio',\n"
                + "       3, 'Tramitación por auto de depuración',\n"
                + "       4, 'Tramitación sin audiencias',\n"
    ...
    public ArrayList<String[]> Colectivo_FechaAP() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE, AUTO_DEPURACION, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, FECHA_ACTO_PROCESAL, FECHA_DEPURACION, COMENTARIOS\n"
                + "FROM V3_TR_COLECTIVOJL\n"
                + "WHERE AUTO_DEPURACION = 1\n"
                + "    AND AUDIENCIA_JUICIO = 2\n"
                + "    AND ESTATUS_EXPEDIENTE = 2\n"
    ...
    public ArrayList<String[]> Colectivo_FechaDRAD() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE, AUTO_DEPURACION, AUDIENCIA_JUICIO, ESTATUS_EXPEDIENTE, FECHA_DICTO_RESOLUCION_AD, FECHA_DEPURACION, COMENTARIOS\n"
                + "FROM V3_TR_COLECTIVOJL\n"
                + "WHERE AUTO_DEPURACION = 1\n"
                + "    AND AUDIENCIA_JUICIO = 2\n"
                + "    AND ESTATUS_EXPEDIENTE = 1\n"
    ...
    public ArrayList<String[]> Colectivo_FechaResolAJ() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE, AUTO_DEPURACION, AUDIENCIA_JUICIO, FECHA_DEPURACION, FECHA_AUDIENCIA_JUICIO, COMENTARIOS\n"
                + "FROM V3_TR_COLECTIVOJL\n"
                + "WHERE AUTO_DEPURACION = 2\n"
                + "    AND AUDIENCIA_JUICIO = 1\n"
                + "    AND ESTATUS_EXPEDIENTE=1\n"
    ...
    public ArrayList<String[]> Colectivo_FechaActoProc() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,  EXPEDIENTE_CLAVE, AUTO_DEPURACION, AUDIENCIA_JUICIO, FECHA_ACTO_PROCESAL, FECHA_DEPURACION, FECHA_AUDIENCIA_JUICIO, COMENTARIOS\n"
                + "FROM V3_TR_COLECTIVOJL  \n"
                + "WHERE AUTO_DEPURACION = 2\n"
                + "    AND AUDIENCIA_JUICIO = 1\n"
                + "    AND ESTATUS_EXPEDIENTE = 2\n"
    ...
    public ArrayList<String[]> Huelga_FechaAP() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  EMPLAZAMIENTO_HUELGA, ESTATUS_EXPEDIENTE, FECHA_ACTO_PROCESAL, FECHA_EMPLAZAMIENTO, COMENTARIOS\n"
                + "FROM V3_TR_HUELGAJL \n"
    ...
    public ArrayList<String[]> Huelga_FechaAudi() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE,   PREHUELGA, FECHA_AUDIENCIA, FECHA_EMPLAZAMIENTO, COMENTARIOS\n"
                + "FROM V3_TR_HUELGAJL \n"
                + "WHERE PREHUELGA = 1\n"
    ...
    public ArrayList<String[]> Huelga_FechaEstallaH() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  PREHUELGA, FECHA_ESTALLAM_HUELGA, FECHA_AUDIENCIA, COMENTARIOS\n"
                + "FROM V3_TR_HUELGAJL \n"
    ...
    public ArrayList<String[]> Huelga_FechaEstallaH2() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  FECHA_ESTALLAM_HUELGA, COMENTARIOS\n"
                + "FROM V3_TR_HUELGAJL \n"
                + "WHERE  ESTALLAMIENTO_HUELGA = 1\n"
                + "AND ESTATUS_EXPEDIENTE = 1   \n"
    ...
    public ArrayList<String[]> ColectEconom_FechaAP() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO,EXPEDIENTE_CLAVE,  AUDIENCIA_ECONOM, ESTATUS_EXPEDIENTE, FECHA_ACTO_PROCESAL, FECHA_AUDIENCIA_ECONOM, COMENTARIOS\n"
                + "FROM V3_TR_COLECT_ECONOMJL\n"
    ...
    public ArrayList<String[]> ColectEconom_FechaResol() {
        String sql = "SELECT SUBSTR(CLAVE_ORGANO,0,2) AS ENTIDAD, CLAVE_ORGANO, EXPEDIENTE_CLAVE,  AUDIENCIA_ECONOM, ESTATUS_EXPEDIENTE, FECHA_RESOLUCION, FECHA_AUDIENCIA_ECONOM, COMENTARIOS\n"
                + "FROM V3_TR_COLECT_ECONOMJL\n"
                + "WHERE AUDIENCIA_ECONOM = 1\n"
                + "    AND ESTATUS_EXPEDIENTE = 1\n"
