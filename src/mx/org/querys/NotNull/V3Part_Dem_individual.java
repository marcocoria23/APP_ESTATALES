...
public class V3Part_Dem_individual {
    ...
    private static final Logger LOGGER = Logger.getLogger(V3Part_Dem_individual.class.getName());
    ...
    public ArrayList Tipo_persona(Connection con) {
        Array = new ArrayList<>();
        ...
        try (
            ...
            LOGGER.log(Level.SEVERE, "Error en Tipo_persona()", ex);
        }
